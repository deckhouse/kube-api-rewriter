module github.com/deckhouse/kube-api-rewriter/examples/get-kubevirt-vm
...
replace github.com/deckhouse/virtualization/src/kubevirt-rules => github.com/deckhouse/virtualization/src/kubevirt-rules v1.7.0
